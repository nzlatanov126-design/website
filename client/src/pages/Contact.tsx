      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 bg-accent text-accent-foreground overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-400 mb-8">Имате въпроси или искате да обсъдим вашия проект? Ние сме тук, за да помогнем. Свържете се с нас по удобен за вас начин.</p>
        ...
        <section className="py-20 bg-accent text-white">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <p className="text-gray-400 text-lg mb-8">Не чакайте повече. Свържете се с нас днес и нека започнем да планираме вашия перфектен ремонт.</p>
            <Button size="lg" asChild className="rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold uppercase tracking-wider h-14 px-8">
