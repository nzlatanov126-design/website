    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="relative py-10 md:py-20 bg-accent text-accent-foreground overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold font-display mb-6 text-white">Ремонт на офис</h1>
              <p className="text-xl text-gray-200 mb-8">Продуктивни, модерни и представителни пространства за успеха на вашия бизнес.</p>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              <div>
                ...
                <ul className="space-y-4">
                  {["Обособяване на открити и затворени пространства", "Мрежова и електро инфраструктура", "Акустични решения", "Подове за високо натоварване", "Декор, съобразен с бранда"].map((item, i) => (
              ...
              <div className="bg-secondary/30 p-8 rounded-2xl border border-border">
                ...
                <div className="space-y-6">
                  {[{ step: "01", title: "Проучване", desc: "Разбиране на работния процес и технически нужди." }, { step: "02", title: "Изграждане", desc: "Ефективно изпълнение за минимално време на престой." }, { step: "03", title: "Довършване", desc: "Полиране за професионална визия." }].map((item, i) => (
        ...
        <section className="py-20 bg-secondary/30 border-y border-border text-center max-w-2xl mx-auto container rounded-2xl mb-20 mt-10 p-10">
          ...
          <p className="text-muted-foreground mb-8">B2B проектите се офертират на база квадратни метри и ниво на спецификация.</p>
          <div className="p-6 bg-white border border-border rounded-2xl inline-block px-12">
            <p className="text-sm font-semibold uppercase tracking-widest text-primary mb-2">Ориентировъчно от</p>
            <p className="text-4xl font-black text-foreground font-display">80 лв. / м²</p>
          </div>
        </section>
      </main>
      <Footer />
