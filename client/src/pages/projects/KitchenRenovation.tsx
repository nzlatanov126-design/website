        ...
        <section className="relative py-10 md:py-20 bg-accent text-accent-foreground overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold font-display mb-6 text-white">Ремонт на кухня</h1>
              <p className="text-xl text-gray-200 mb-8">Модерни, функционални кухни, проектирани за вашия начин на живот и кулинарни приключения.</p>
