        ...
        <section className="relative py-10 md:py-20 bg-[#0F172A] text-white overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <motion.div 
              ...
              className="max-w-3xl"
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6">Ремонт на баня</h1>
              <p className="text-xl text-slate-400 mb-8">Модерен дизайн, хидроизолация и експертна облицовка за вашето лично убежище.</p>
