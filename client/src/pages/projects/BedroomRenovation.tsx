        ...
        <section className="relative py-20 bg-accent text-accent-foreground overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
              <h1 className="text-4xl md:text-6xl font-bold font-display mb-6">Ремонт на спалня</h1>
              <p className="text-xl text-gray-400 mb-8">Създаване на мирно и стилно убежище за почивка и релаксация.</p>
