...
export default function BedroomRenovation() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="relative py-10 md:py-20 bg-[#0F172A] text-white overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6">Ремонт на спалня</h1>
              <p className="text-xl text-slate-400 mb-8">Създаване на мирно и стилно убежище за почивка и релаксация.</p>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              <div>
                ...
                <ul className="space-y-4">
                  {["Довършване на стени и тавани", "Проектиране и монтаж на осветление", "Монтаж на подови настилки", "Опции за вграден гардероб", "Декоративно довършване"].map((item, i) => (
              ...
              <div className="bg-secondary/30 p-8 rounded-2xl border border-border">
                ...
                <div className="space-y-6">
                  {[{ step: "01", title: "Планиране", desc: "Планиране за комфорт и съхранение." }, { step: "02", title: "Изпълнение", desc: "Професионална работа с минимално смущение." }, { step: "03", title: "Детайли", desc: "Финални довършителни работи и декор." }].map((item, i) => (
        ...
        <section className="py-20 bg-secondary/30 border-y border-border text-center max-w-2xl mx-auto container rounded-2xl mb-20 mt-10 p-10">
          ...
          <p className="text-muted-foreground mb-8">Налични са опции за лек ремонт или дълбока реновация.</p>
          <div className="p-6 bg-white border border-border rounded-2xl inline-block px-12">
            ...
            <p className="text-4xl font-black text-foreground font-display">1 500+ лв.</p>
          </div>
        </section>
      </main>
      <Footer />
